    ...
    <div style={{ minHeight: '100vh', background: 'var(--color-bg-darkest)', fontFamily: '"Segoe UI", sans-serif', color: 'var(--color-accent)' }}>
      ...
      <div style={{ background: `linear-gradient(135deg, var(--color-primary), var(--color-bg-darker))`, color: 'var(--color-accent)', padding: '60px 30px', textAlign: 'center', borderBottom: `1px solid var(--color-border)` }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ padding: '8px 16px', background: 'rgba(176, 228, 204, 0.1)', borderRadius: 8, fontSize: 14 }}>📊 Real-time Execution</div>          <Link to="/study-calendar" style={{ padding: '8px 16px', background: 'rgba(16, 185, 129, 0.2)', borderRadius: 8, fontSize: 14, color: '#34d399', textDecoration: 'none', fontWeight: 600, border: '1px solid #34d39940' }}>📅 30-Day Study Plan</Link>          <Link to="/study-calendar-45" style={{ padding: '8px 16px', background: 'rgba(99, 102, 241, 0.2)', borderRadius: 8, fontSize: 14, color: '#a5b4fc', textDecoration: 'none', fontWeight: 600, border: '1px solid #6366f140' }}>🗓️ 45-Day Blind 75</Link>          <Link to="/study-calendar-60" style={{ padding: '8px 16px', background: 'rgba(168, 85, 247, 0.2)', borderRadius: 8, fontSize: 14, color: '#c4b5fd', textDecoration: 'none', fontWeight: 600, border: '1px solid #a855f740' }}>🚀 60-Day NeetCode 150</Link>          <Link to="/study-calendar-90" style={{ padding: '8px 16px', background: 'rgba(239, 68, 68, 0.2)', borderRadius: 8, fontSize: 14, color: '#fca5a5', textDecoration: 'none', fontWeight: 600, border: '1px solid #ef444440' }}>🏆 90-Day AlgoMaster 300</Link>        </div>
      </div>
